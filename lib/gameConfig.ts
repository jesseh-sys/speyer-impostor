...
export const TASKS: Omit<Task, 'id'>[] = [
  ...
  { title: 'Sketch something', location: 'music', description: 'Your pencil moves across the paper. The silence is deafening.', type: 'mini-game', miniGameType: 'decode' },
  { title: 'Organize locker', location: 'lobby', description: 'Your combination feels wrong. It opens anyway.', type: 'mini-game', miniGameType: 'defrag' },
  { title: 'Check homework', location: 'deard', description: 'The assignments look normal. Except the one written in red.', type: 'mini-game', miniGameType: 'password' },
  { title: 'Return book', location: 'speyer', description: 'The book feels heavier than when you checked it out.', type: 'quick' },
  { title: 'Sharpen pencils', location: 'lobby', description: 'The sharpener grinds louder than it should.', type: 'mini-game', miniGameType: 'defrag' },
  { title: 'Fill water bottle', location: 'cafeteria', description: 'The water runs clear. Then cloudy. Then clear again.', type: 'quick' },
  { title: 'Check schedule', location: 'meyers', description: 'Your name is on the schedule. Twice.', type: 'mini-game', miniGameType: 'hack' },
  ...
  { title: 'Sign attendance', location: 'lobby', description: 'Everyone else signed. In the same handwriting.', type: 'mini-game', miniGameType: 'hack' },
  { title: 'Water the plant', location: 'suib', description: 'It turns to face you. It was already facing you.', type: 'quick' },
  { title: 'Collect papers', location: 'mj', description: 'The papers are blank. Every single one.', type: 'mini-game', miniGameType: 'decode' },
